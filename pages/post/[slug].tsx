    ...
    return (
        <main>
            ...
            <form onSubmit={handleSubmit(onSubmit)} action="" className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
                ...
                <input {...register("_id")} name="_id"
                value={post._id} type="hidden" className="" 
                />
                ...
                <label htmlFor="" className="block mb-5">
                    ...
                    placeholder="Enter valid email" type="email" 
                    className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring" 
                    />
                </label>
                <label htmlFor="" className="block mb-5">
...
export const getStaticProps: GetStaticProps = async ({ params }) =>{
    ...
    return{
        ...
        revalidate: 60, //after 60sec it will revalidate the cache
    }
}